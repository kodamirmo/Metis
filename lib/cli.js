...
if (!fs.existsSync(globalConfigPath)) {
    if (process.env.Soyuz_ROOT_DIR) return createRootDir(process.env.Soyuz_ROOT_DIR);
    console.log(
    	'=============================== Soyuz ==============================='.green + '\n' +
        'Hello! It seems it\'s your first time running Soyuz on this machine.\n' +
        'Please specify a directory for Soyuz to put stuff in.\n' +
